...
`skills/orchestrate/SKILL.md`, spending real sessions, the subagents they spawn and at least one
`gpt-6-astra` Codex turn, so without `CODEX_DELEGATE_LIVE_ORCHESTRATE=1` it prints one NOT RUN line and
exits 0.
